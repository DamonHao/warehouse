// C20C20WordList2.cpp : Defines the entry point for the console application.
//
...
int main(int argc, char* argv[]) {
	...
	while (p != end) {
		...
		// when p == end, *p will cause error in some compiler
		// so the condition !isalpha(*p) should be put behind
