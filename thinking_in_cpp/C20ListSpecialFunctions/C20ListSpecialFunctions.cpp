// C20ListSpecialFunctions.cpp : Defines the entry point for the console application.
//
...
int main() {
	...
	//Inside the list::remove, a object will created by 
	//copy-constructor,with the same type of parameter;
	l5.remove(l5.front());
	print(l5, "l5 after remove()");
	//the merge() only works when both lists have been sorted
	l1.sort(); l5.sort();
	l5.merge(l1);
